...
{
    public partial class Team120LibraryContext : DbContext
    {
        public Team120LibraryContext()
        {
        }

        public Team120LibraryContext(DbContextOptions<Team120LibraryContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("Server=atr.eng.utah.edu;User Id=u1211977;Password=pwd;Database=Team120Library");
            }
        }
