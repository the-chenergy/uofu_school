...
public class BinaryTreeDemo
{
	public static void main(String[] args)
	{
		...
		// Implement your b tree. What is the sequence of its preorder, postorder, inorder, and
		// level-order traversals?
		
		BinaryNode<String> b = new BinaryNode<>("1",
			new BinaryNode<>("2", new BinaryNode<>("4", new BinaryNode<>("7"), null), new BinaryNode<>("5")),
			new BinaryNode<>("3", null, new BinaryNode<>("6")));
		 ...
		 * 
		 * System.out.print("\nPreorder: "); b3.printPreorder(); System.out.println();
		 * 
		 * System.out.print("Postorder: "); b3.printPostorder(); System.out.println();
		 * 
		 * System.out.print("Inorder: "); b3.printInorder(); System.out.println();
		 */
	}
}
