 ...
 * 
 * Since the data structure is recursively defined, a single binary node designated as the root
 * of a tree represents a binary tree.
 * 
...
public class BinaryNode<T>
{
	...
	/**
	 * Prints the elements of the tree rooted at "this" node, using preorder (element followed by
	 * left subtree followed by right subtree) traversal.
	 */
	...
	/**
	 * Prints the elements of the tree rooted at "this" node, using inorder (left subtree followed
	 * by element followed by right subtree) traversal.
	 */
	...
	/**
	 * Prints the elements of the tree rooted at "this" node, using postorder (left subtree followed
	 * by right subtree followed by element) traversal.
	 */
	...
	/**
	 * Prints the elements of the tree rooted at "this" node, using level-order (breadth-first)
	 * traversal.
	 */
	public void printLevelorder()
	{
		// FILL IN with a level order traversal, use a queue (no recursion)
	}
	
	/**
	 * @return a string containing all of the edges in the tree rooted at "this" node, in DOT format
	 */
