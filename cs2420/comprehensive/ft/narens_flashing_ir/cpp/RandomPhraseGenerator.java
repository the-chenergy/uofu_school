package comprehensive.ft.narens_flashing_ir.cpp;
...
public class RandomPhraseGenerator
{
	...
	{
		// args = new String[] {"src/comprehensive/poetic_sentence.g", "91483647"};
		// args = new String[] {"src/comprehensive/mathematical_expression.g", "100 000".replace(" ", "")};
		// args = new String[] {"src/comprehensive/stupid.g", "1".replace(" ", "")};
		// args = new String[] {"src/comprehensive/assignment_extension_request.g", "10 000 000".replace(" ", "")};
